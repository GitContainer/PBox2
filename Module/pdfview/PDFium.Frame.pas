...
function TPDFiumFrame.DoMouseWheel(Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  FReload                := True;
...
procedure TPDFiumFrame.MouseDown(Button: TMouseButton; Shift: TShiftState; x, y: Integer);
var
  i: Integer;
begin
  inherited;
...
procedure TPDFiumFrame.MouseUp(Button: TMouseButton; Shift: TShiftState; x, y: Integer);
begin
  inherited;
...
begin
{$IFDEF TRACK_EVENTS}WriteLn('WM_PAINT ', Paints);
  Inc(Paints); {$ENDIF}
