...
var fStream: IStream;
    Len: {$ifdef ISDELPHIXE8}LargeUInt{$else}Int64{$endif};
//    Dummy: {$ifdef ISDELPHIXE8}LargeUInt{$else}Int64{$endif};
    tmp: pointer;
  ...
  try
    ...
    if (MaxPixelsForBiggestSide=0) or
      ...
      try
        ...
        XLSSynGdiPlus.SaveAs(Bmp,Stream,Format,CompressionQuality,0,BitmapSetResolution);
      finally
        Bmp.Free;
      end;
    end;
